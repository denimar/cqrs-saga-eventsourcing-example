...
exports.mongoNativeConnect = exports.customersCol = exports.mongoDb = void 0;
var mongodb_1 = require("mongodb");
var logger_1 = __importDefault(require("./logger"));
var mongoDb;
exports.mongoDb = mongoDb;
var customersCol;
exports.customersCol = customersCol;
var mongoNativeConnect = function (pid, onConnect) {
    ...
    mongodb_1.MongoClient.connect(mongoURI, { useUnifiedTopology: true }, function (err, client) {
        ...
        exports.customersCol = customersCol = mongoDb.collection('customers');
        onConnect();
    });
};
